 ...
 * @author juan ivan
 */
public class MultasBorradas extends javax.swing.JFrame {
        ArrayList<Multa> lstMultasBorradas = new ArrayList<>();

    public MultasBorradas() {
        initComponents();
   ...
   int idMulta=0;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MultasBorradas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MultasBorradas().setVisible(true);
            }
        });
    }
